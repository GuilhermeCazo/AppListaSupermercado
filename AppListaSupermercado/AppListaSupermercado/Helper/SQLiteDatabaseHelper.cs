...
namespace AppListaSupermercado.Helper
{
    ...
    public class SQLiteDatabaseHelper
    {
        ...
        {
            string sql = "UPDATE Produto SET Descricao=?, Preco_Unico=?, Quantidade=? WHERE id= ? ";
            return _conn.QueryAsync<Produto>(sql, p.Descricao, p.Preco_Unico, p.Quantidade, p.Id);
        }
